...
#	url(r'^restaurants/(?P<pk>\d+)/\$',RestaurantDetail.as_view(), name='restaurant_detail'),
	...
	#url(r'^restaurant/create/\$',RestaurantsCreate.as_view(),name='restaurant_create'),
	
	#url(r'^restaurants/(?P<pk>\d+)/edit/\$',UpdateView.as_view(model = Restaurants, template_name = 'myrestaurants/form.html',form_class = RestaurantForm), name='restaurant_edit'),
